...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar rounded-lg bg-background-tertiary p-3 shadow [--cell-size:--spacing(8)]",
      ...
      classNames={{
        ...
        dropdown: cn(
          "absolute bg-popover inset-0 opacity-0 bg-background-tertiary rounded-md shadow-lg",
        ...
        day: cn(
          "relative w-full h-full p-0 text-center [&:first-child[data-selected=true]_button]:rounded-l-md [&:last-child[data-selected=true]_button]:rounded-r-md group/day aspect-square select-none data-[selected=true]:rounded-md data-[selected=true]:bg-accent-primary data-[selected=true]:text-white",
        ...
        today: cn(
          "bg-background-primary rounded-md text-white",
